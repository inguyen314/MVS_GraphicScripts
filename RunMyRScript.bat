@echo off
REM "C:\Program Files\R\R-4.2.2\bin\Rscript.exe" "C:\Users\B3ECHIHN\Documents\water_control\web\rebuild_internal_web\MVS_GraphicScripts\MVK_ReservoirStatusGraphics7.R" > output.log 2>&1
