...
if (Sys.getenv("USERNAME") == "B3ECHIHN") {
  ...
  graphicDirectory <- 'C:/wc/MVS_GraphicScripts/'
  pdf(file = 'C:/wc/MVS_GraphicScripts/Rplots.pdf')
  
  # Define Location for Supporting Images
  img1 <- get_png("C:/wc/MVS_GraphicScripts/cloud.png")
  img2 <- get_png("C:/wc/MVS_GraphicScripts/usace_mvs_logo.png")
}
